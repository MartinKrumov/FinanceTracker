...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiError> globalExceptionHandler(Throwable ex, WebRequest request) {
    ...
    public ResponseEntity<ApiError> entityAlreadyExistHandler(Exception ex, WebRequest request) {
        log.error(ex.getMessage(), ex);
        return buildResponseEntity(HttpStatus.CONFLICT, List.of(ex.getLocalizedMessage()), request);
    }
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        Optional.ofNullable(ex.getSupportedHttpMethods())
                .ifPresent(httpMethods ->
                        httpMethods.forEach(t -> sb.append(t).append(" "))
                );
     ...
     */
    private ResponseEntity<ApiError> buildResponseEntity(HttpStatus httpStatus, List<String> errorMessages, WebRequest request) {
        return ResponseEntity
                .status(httpStatus)
                .body(buildApplicationException(request, errorMessages));
    }
